...
def output_data():
    ...
    b='/home/template_fitting/fonts/'+y+'.ttf'
    c = '/home/template_fitting/backgrounds/' + z + '.jpg'
    d='/home/template_fitting/backgrounds/' + t + '.json'
    main(a,b,c,d)
    return (a)
#    return send_file(
...
if __name__ == "__main__":
    ...
    app.run(host='http://106.75.245.110:5080/')
